<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Гроубокс Mammoth Pro Dark Room',
    'longtitle' => '',
    'description' => '',
    'alias' => 'grouboks-mammoth-pro-dark-room',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p style="font-size: 18px; font-weight: bolder;"><img style="float: left;" src="assets/img/growbox-Mammoth-Pro-kypit.png" alt="" width="440" height="440" /><br />Модель: Гроубокс Mammoth Pro (Dark Room)</p>
<p style="font-size: 18px; font-weight: bolder;">Параметры: 100 - 100 - 200 см</p>
<p>Компактная конструкция для выращивания растений. Проста в сборке/разборке.</p>
<p><span style="font-size: 18px;">Особенности модели <span>Mammoth Pro (Dark Room)</span>: </span></p>
<ul>
<li>Герметичность и наличие "рукавов" для монтажных работ. Это обеспечивает отсутствие запаха.</li>
<li>Водонепроницаемое дно!</li>
<li>Особая светоотражающая поверхность Diamond Technology обеспечивает 95% светоотражения создают лучшие условия освещенности.</li>
<li>Конструкция собирается без использования инструментов.</li>
<li>Светонепроницаемая конструкция.</li>
<li>В конструкцию входят трубки и перекладины, которые служат как подвесы для светильников, фильтров и тд.</li>
</ul>
<div class="intro__rec_2"><br /><a class="button button_rec" onclick="window.location = \'/zakazat-obratij-zvonok.html?name=[[*pagetitle]]\';"><span>Заказать</span></a></div>',
    'richtext' => 1,
    'template' => 7,
    'menuindex' => 5,
    'searchable' => 1,
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1452595942,
    'editedby' => 1,
    'editedon' => 1452634584,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1452595980,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'grouboks-mammoth-pro-dark-room.html',
    'uri_override' => 0,
...
<div class="wrapper"><div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="oborudovanie-dlya-vyirashhivaniya-marixuanyi.html">Оборудование для выращивания</a></li><li><a href="grouboks-dlya-marixuanyi.html">Гроутент и гроубокс для марихауны купить</a></li><li>Гроубокс Mammoth Pro Dark Room</li></ul></div>     </div>
<h1>Гроубокс Mammoth Pro Dark Room</h1>
    <div class="col2">
      <div class="col-l">
        <div class="articles"> <p style="font-size: 18px; font-weight: bolder;"><img style="float: left;" src="assets/img/growbox-Mammoth-Pro-kypit.png" alt="" width="440" height="440" /><br />Модель: Гроубокс Mammoth Pro (Dark Room)</p>
<p style="font-size: 18px; font-weight: bolder;">Параметры: 100 - 100 - 200 см</p>
<p>Компактная конструкция для выращивания растений. Проста в сборке/разборке.</p>
<p><span style="font-size: 18px;">Особенности модели <span>Mammoth Pro (Dark Room)</span>: </span></p>
<ul>
...
<div class="intro__rec_2"><br /><a class="button button_rec" onclick="window.location = \'/zakazat-obratij-zvonok.html?name=Гроубокс Mammoth Pro Dark Room\';"><span>Заказать</span></a></div></div></div>
<div class="col-r">
<div class="col-r">
...
<form class="univer-action__form" action="grouboks-mammoth-pro-dark-room.html#univer" method="post">
...
<div class="modal-windows">
    <div class="modal-forms js-question-form">
        ...
        <div class="modal-forms-i">
            <form class="apply-form apply-form_modal js-apply-form validate" method="post" action="grouboks-mammoth-pro-dark-room.html">
...
<div class="modal-forms js-telefon-form">
        ...
        <div class="modal-forms-i">
 <form class="apply-form apply-form_modal js-apply-form validate" method="post" id="phone_form"  action="grouboks-mammoth-pro-dark-room.html">
...
',
    '[[*intro]]' => '',
    '[[Breadcrumb]]' => '<ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="oborudovanie-dlya-vyirashhivaniya-marixuanyi.html">Оборудование для выращивания</a></li><li><a href="grouboks-dlya-marixuanyi.html">Гроутент и гроубокс для марихауны купить</a></li><li>Гроубокс Mammoth Pro Dark Room</li></ul>',
...
<div class="subs-social"><a class="subs-social__vk" href="https://vk.com/edu_vienna_group"></a> <a class="subs-social__fb" href="http://www.facebook.com/eduvienna"></a> <a class="subs-social__tw" href="http://twitter.com/edu_vienna"></a> <a class="subs-social__gp" href="https://plus.google.com/u/0/114251018215715546789"></a> <a class="subs-social__in" href="http://www.instagram.com/edu_vienna"></a> <a class="subs-social__yt" href="http://www.youtube.com/user/eduviennacom"></a>!--></div>
    ...
    '[[~66]]' => 'grouboks-mammoth-pro-dark-room.html',
    '[[$count]]' => '
[[!FormIt?
   &formName=`count`
   &hooks=`spam,email,hook_FormIt_megaplanCreateClient,redirect`
