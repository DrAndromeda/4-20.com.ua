<?php  return array (
  ...
  array (
    ...
    'longtitle' => 'Чтобы купить Growth Technology обращайтесь к менеджерам',
    'description' => '',
...
<li><a href="zakazat-obratij-zvonok.html" rel="nofollow"><img class="col3__img" src="assets/img/CLONEX-GEL-купить.jpg" alt="" /></a>
<div class="col3__info"><a class="col3__title col3__title_univer" href="zakazat-obratij-zvonok.html">CLONEX GEL (КЛОНЕКС) 50мл</a>
<div class="col3__desc">
<p>Гель для результативного колнирования. Обеспечивает высокий процент укоренения даже самых прихотливых растений.</p>
</div>
<div class="button button_adm"><span style="font-size: 20px; font-weight: bolder;">450 грн</span></div>
<a class="button button_adm" href="zakazat-obratij-zvonok.html?name=[[*pagetitle]]" rel="nofollow"> <span>Заказать сейчас</span> </a></div>
</li>
<li><a href="zakazat-obratij-zvonok.html" rel="nofollow"><img class="col3__img" src="assets/img/CLONEX-MIST-купить.jpg" alt="" /></a>
<div class="col3__info"><a class="col3__title col3__title_univer" href="zakazat-obratij-zvonok.html">CLONEX MIST СПРЕЙ 100 МЛ</a>
<div class="col3__desc">
<p>Для укоренения черенков. Создает пышную корневую систему.</p>
</div>
<div class="button button_adm"><span style="font-size: 20px; font-weight: bolder;">430 грн</span></div>
<a class="button button_adm" href="zakazat-obratij-zvonok.html?name=[[*pagetitle]]" rel="nofollow"> <span>Заказать сейчас</span> </a></div>
</li>
...
<li><a href="zakazat-obratij-zvonok.html" rel="nofollow"><img class="col3__img" src="assets/img/SPIDER-MITE-CONTROL-купить.jpg" alt="" /></a>
<div class="col3__info"><a class="col3__title col3__title_univer" href="zakazat-obratij-zvonok.html">SMC (SPIDER MITE CONTROL) 100 МЛ</a>
<div class="col3__desc">
<p>Для защиты растений от паутинного клеща.</p>
</div>
<div class="button button_adm"><span style="font-size: 20px; font-weight: bolder;">720 грн</span></div>
<a class="button button_adm" href="zakazat-obratij-zvonok.html?name=[[*pagetitle]]" rel="nofollow"> <span>Заказать сейчас</span> </a></div>
</li>
</ul>',
    'richtext' => 1,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'udobreniya-growth-technology.html',
    'uri_override' => 0,
...
<head>
<title>Чтобы купить Growth Technology обращайтесь к менеджерам</title>
<meta charset="utf-8">
...
<div class="modal-windows">
    <div class="modal-forms js-question-form">
        ...
        <div class="modal-forms-i">
            <form class="apply-form apply-form_modal js-apply-form validate" method="post" action="udobreniya-growth-technology.html">
...
<div class="modal-forms js-telefon-form">
        ...
        <div class="modal-forms-i">
 <form class="apply-form apply-form_modal js-apply-form validate" method="post" id="phone_form"  action="udobreniya-growth-technology.html">
...
<!-- /Yandex.Metrika counter !-->
    ...
    '[[*id]]' => 73,
    '[[~73]]' => 'udobreniya-growth-technology.html',
    '[[$forms]]' => '[[#!FormIt?
   &formName=`forms1`
   &hooks=`email,hook_FormIt_megaplanCreateClient,redirect`
   &emailTpl=`email_tpl`
