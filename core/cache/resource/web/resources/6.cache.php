...
<p>Из-за повышения артериального давления и частоты сердечных сокращений во время курения конопли снижается кислородная способность крови (гипоксия). В течении первого часа после употребления некоторые люди  попадают в группу риска по приступу инфаркта.</p>',
    ...
    array (
      0 => 'intro',
      1 => '<div class="university-intro" style="background: #e6e7e7 url(/assets/images/sok2/7.png) top no-repeat">   <div class="wrapper">     <div class="university-intro-i">     <!--  <h1>пупыпыукпк</h1>       <ul class="university-info"> <li></li> <li></li> <li></li> <li> <a href="#"></a></li> </ul>            <a class="button button_intro" href="[[~47]]"> <span></span> </a>!--> </div>   </div> </div>',
      2 => 'text',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'keywords',
      1 => 'вред от марихуаны, конопля вред, вред от марихуаны, чем вредно курение марихуаны, вредно ли курить траву, вред марихуаны',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<head>
<title>Чем вредно курение марихуаны и какой вред марихуаны на органы</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0"/>
<meta name="keywords" content="вред от марихуаны, конопля вред, вред от марихуаны, чем вредно курение марихуаны, вредно ли курить траву, вред марихуаны" />
<meta name="description" content="Узнайте про вред марихуаны, вредно ли курить траву девушкам и чем вредна конопля для здоровья спортсменов. " />
...
<div class="university-intro" style="background: #e6e7e7 url(/assets/images/sok2/7.png) top no-repeat">   <div class="wrapper">     <div class="university-intro-i">     <!--  <h1>пупыпыукпк</h1>       <ul class="university-info"> <li></li> <li></li> <li></li> <li> <a href="#"></a></li> </ul>            <a class="button button_intro" href="chto-takoe-anasha.html"> <span></span> </a>!--> </div>   </div> </div>

<div class="wrapper"><div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="kurenie-marixuanyi.html">Курение марихуаны</a></li><li>Вред от марихуаны</li></ul></div>     </div>
<h1>Вред от марихуаны</h1>
    <div class="col2">
      <div class="col-l">
        <div class="articles"> <p>Конопля, трава, каннабис и она же марихуана имеет десятки способов употребления и курения, но несмотря не на что растение это является наркотиком, и имеет 100% влияние на организм человека. Изучив десятки ресурсов с псевдо правдивой информацией про влияние и <strong>вред от марихуаны</strong>, мы создали список действительных и 100% фактов которые подтверждены независимыми источниками с серьезной репутацией. </p>
<p>Одни употребляют травку чтоб расслабиться, другие чтоб облегчить болезненные симптомы, третьи просто от любви к ней =) Какой бы причина употребления у Вас не была, знать и понимать последствия употребления это отличная возможность избежать проблем.</p>
<p><img title="Узнайте какой вред от марихуаны" src="assets/images/вред-от-марихуаны.png" alt="Непоправимый вред от марихуаны" width="100%" /></p>
<h2>Какой вред марихуаны и чем вредно курение марихуаны в больших количествах</h2>
<p style="font-size: 16px; color: #4bd12e;">Факт №1. Вред марихуаны на мозговую активность.</p>
...
<p style="font-size: 16px; color: #4bd12e;">Факт №6. Во время интоксикации (момента после курения или принятия травки в любом другом виде) у некоторых людей наступает приступ тахикардии.</p>
<p style="font-size: 16px; color: #4bd12e;">Факт №7. Регулярное курение марихуаны это возможность инфаркта.</p>
<p>Из-за повышения артериального давления и частоты сердечных сокращений во время курения конопли снижается кислородная способность крови (гипоксия). В течении первого часа после употребления некоторые люди  попадают в группу риска по приступу инфаркта.</p></div></div>
<div class="col-r">
<div class="col-r">
...
<form class="univer-action__form" action="vred-ot-marixuanyi.html#univer" method="post">
...
<div class="modal-windows">
    <div class="modal-forms js-question-form">
        ...
        <div class="modal-forms-i">
            <form class="apply-form apply-form_modal js-apply-form validate" method="post" action="vred-ot-marixuanyi.html">
...
<div class="modal-forms js-telefon-form">
        ...
        <div class="modal-forms-i">
 <form class="apply-form apply-form_modal js-apply-form validate" method="post" id="phone_form"  action="vred-ot-marixuanyi.html">
...
',
  ...
  array (
    '[[*longtitle]]' => 'Чем вредно курение марихуаны и какой вред марихуаны на органы',
    '[[*keywords]]' => 'вред от марихуаны, конопля вред, вред от марихуаны, чем вредно курение марихуаны, вредно ли курить траву, вред марихуаны',
    '[[*description]]' => 'Узнайте про вред марихуаны, вредно ли курить траву девушкам и чем вредна конопля для здоровья спортсменов. ',
    '[[$head]]' => '<head>
<title>Чем вредно курение марихуаны и какой вред марихуаны на органы</title>
<meta charset="utf-8">
...
',
    ...
    '[[*intro]]' => '<div class="university-intro" style="background: #e6e7e7 url(/assets/images/sok2/7.png) top no-repeat">   <div class="wrapper">     <div class="university-intro-i">     <!--  <h1>пупыпыукпк</h1>       <ul class="university-info"> <li></li> <li></li> <li></li> <li> <a href="#"></a></li> </ul>            <a class="button button_intro" href="chto-takoe-anasha.html"> <span></span> </a>!--> </div>   </div> </div>',
    '[[Breadcrumb]]' => '<ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="kurenie-marixuanyi.html">Курение марихуаны</a></li><li>Вред от марихуаны</li></ul>',
    '[[$bread]]' => '<div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="kurenie-marixuanyi.html">Курение марихуаны</a></li><li>Вред от марихуаны</li></ul></div>     </div>',
    '[[*pagetitle]]' => 'Вред от марихуаны',
    '[[*id]]' => 6,
    '[[Wayfinder?
			&startId=`6`
