<?php  return array (
  ...
  array (
    ...
    array (
      0 => 'keywords',
      1 => 'Слабопахнущие сорта марихуаны, слабопахнущие автоцветы, слабопахнущие семена',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<head>
<title>Самые слабопахнущие сорта марихуаны </title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0"/>
<meta name="keywords" content="Слабопахнущие сорта марихуаны, слабопахнущие автоцветы, слабопахнущие семена" />
<meta name="description" content="Здесь представлены слабопахнущие сорта марихуаны автоцветы." />
...
<div class="wrapper"><div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="semena-marixuanyi.html">Семена марихуаны</a></li><li>Слабопахнущие сорта марихуаны</li></ul></div>     </div>
<h1>Слабопахнущие сорта марихуаны</h1>
    <div class="col2">
      <div class="col-l">
...
<form class="univer-action__form" action="slabopaxnushhie-sorta-marixuanyi.html#univer" method="post">
...
<div class="modal-windows">
    <div class="modal-forms js-question-form">
        ...
        <div class="modal-forms-i">
            <form class="apply-form apply-form_modal js-apply-form validate" method="post" action="slabopaxnushhie-sorta-marixuanyi.html">
...
<div class="modal-forms js-telefon-form">
        ...
        <div class="modal-forms-i">
 <form class="apply-form apply-form_modal js-apply-form validate" method="post" id="phone_form"  action="slabopaxnushhie-sorta-marixuanyi.html">
...
',
  ...
  array (
    '[[*longtitle]]' => 'Самые слабопахнущие сорта марихуаны ',
    '[[*keywords]]' => 'Слабопахнущие сорта марихуаны, слабопахнущие автоцветы, слабопахнущие семена',
    '[[*description]]' => 'Здесь представлены слабопахнущие сорта марихуаны автоцветы.',
    '[[$head]]' => '<head>
<title>Самые слабопахнущие сорта марихуаны </title>
<meta charset="utf-8">
...
',
    '[[*intro]]' => '',
    '[[Breadcrumb]]' => '<ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="semena-marixuanyi.html">Семена марихуаны</a></li><li>Слабопахнущие сорта марихуаны</li></ul>',
    '[[$bread]]' => '<div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="semena-marixuanyi.html">Семена марихуаны</a></li><li>Слабопахнущие сорта марихуаны</li></ul></div>     </div>',
    '[[*pagetitle]]' => 'Слабопахнущие сорта марихуаны',
    '[[*id]]' => 78,
    '[[Wayfinder?
			&startId=`78`
