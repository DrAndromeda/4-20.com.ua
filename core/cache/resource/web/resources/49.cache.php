...
<p>Для сохранения качеств получившегося феминизированного сорта, гроверу советуют его продолжать клонировать. Такой метод размножения женского растения позволяет избегать цикл оплодотворения, созревания семени и его высеивания в грунт. Вообщем свойства таких женских растений сохраняются как можно лучше.</p>',
    ...
    array (
      0 => 'intro',
      1 => '<div class="university-intro" style="background: #e6e7e7 url(/assets/images/sok2/10.png) top no-repeat">   <div class="wrapper">     <div class="university-intro-i">     <!--  <h1></h1>       <ul class="university-info"></li> <li></li> <li> <a href="#spetsialnosti-universtytetu"></a></li> </ul>            <a class="button button_intro" href="[[~47]]"> <span></span> </a>!--> </div>   </div> </div>',
      2 => 'text',
      3 => NULL,
      4 => 'text',
    ),
...
<meta name="keywords" content="феминизированные семена, феминизированные семена конопли, феминизированные, автоцветущие феминизированные, купить феминизированные семена марихуаны в Украине, что такое феминизированные семена, феминизированные семена марихуаны, автоцветущие феминизированные семена, купить феминизированные семена конопли, феминизированные семена это, как получить феминизированные семена, как вырастить феминизированные семена" />
<meta name="description" content="Данная статья о том что такое феминизированные семена и как за ними правильно ухаживать чтобы добиться достойного результата." />
...
<div class="university-intro" style="background: #e6e7e7 url(/assets/images/sok2/10.png) top no-repeat">   <div class="wrapper">     <div class="university-intro-i">     <!--  <h1></h1>       <ul class="university-info"></li> <li></li> <li> <a href="#spetsialnosti-universtytetu"></a></li> </ul>            <a class="button button_intro" href="chto-takoe-anasha.html"> <span></span> </a>!--> </div>   </div> </div>

<div class="wrapper"><div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="semena-marixuanyi.html">Семена марихуаны</a></li><li>Феминизированные семена</li></ul></div>     </div>
<h1>Феминизированные семена</h1>
    <div class="col2">
      <div class="col-l">
        <div class="articles"> <p>На самом деле существование феминизированных семян марихуаны появился относительно недавно. <strong>Феминизированные семена</strong> конопли были впервые выведены в 1998 году, квалифицированным сидбанком Голландии <span style="font-size: 13px;">Dutch Passion</span>. Именно благодаря этим ребятам зародилась новая ветвь в истории выращивания марихуаны. На сегодняшний день о феминизированных семенах наслышаны многие, поэтому давайте разберемся как правильно с ними обходиться.</p>
<h2>Феминизированные семена конопли это открытие новой истории марихуаны</h2>
<p>Ранее семена марихуаны были исключительно рудералис и требовали максимального трепетного ухода гровера за растением, дабы получить достойный результат труда. Появление же феминизированных семян открыло новую эру в процессе выращивания и позволило добиваться лучших результатов при меньших усилиях.</p>
<p><img src="assets/img/феминизированные-семена.png" alt="" width="1147" height="417" /></p>
<p style="text-align: center; color: #4bd12e;"><em>Конопляные феминизированные семена это растения марихуаны женского пола, так называемые сенсимилью (sinsemilla). Данные растения являются не опыленными от растений мужского пола, и содержат в себе намного больший уровень ТГК, что и является основной причиной гровинка для многих.</em></p>
...
<p>Для сохранения качеств получившегося феминизированного сорта, гроверу советуют его продолжать клонировать. Такой метод размножения женского растения позволяет избегать цикл оплодотворения, созревания семени и его высеивания в грунт. Вообщем свойства таких женских растений сохраняются как можно лучше.</p></div></div>
<div class="col-r">
<div class="col-r">
...
<form class="univer-action__form" action="feminizirovannyie-semena.html#univer" method="post">
...
<div class="modal-windows">
    <div class="modal-forms js-question-form">
        ...
        <div class="modal-forms-i">
            <form class="apply-form apply-form_modal js-apply-form validate" method="post" action="feminizirovannyie-semena.html">
...
<div class="modal-forms js-telefon-form">
        ...
        <div class="modal-forms-i">
 <form class="apply-form apply-form_modal js-apply-form validate" method="post" id="phone_form"  action="feminizirovannyie-semena.html">
...
',
  ...
  array (
    '[[*longtitle]]' => '',
    '[[*keywords]]' => 'феминизированные семена, феминизированные семена конопли, феминизированные, автоцветущие феминизированные, купить феминизированные семена марихуаны в Украине, что такое феминизированные семена, феминизированные семена марихуаны, автоцветущие феминизированные семена, купить феминизированные семена конопли, феминизированные семена это, как получить феминизированные семена, как вырастить феминизированные семена',
    '[[*description]]' => 'Данная статья о том что такое феминизированные семена и как за ними правильно ухаживать чтобы добиться достойного результата.',
    '[[$head]]' => '<head>
<title></title>
<meta charset="utf-8">
...
',
    ...
    '[[Breadcrumb]]' => '<ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="semena-marixuanyi.html">Семена марихуаны</a></li><li>Феминизированные семена</li></ul>',
    '[[$bread]]' => '<div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="semena-marixuanyi.html">Семена марихуаны</a></li><li>Феминизированные семена</li></ul></div>     </div>',
    '[[*pagetitle]]' => 'Феминизированные семена',
    '[[*id]]' => 49,
    '[[Wayfinder?
			&startId=`49`
...
<div class="subs-social"><a class="subs-social__vk" href="https://vk.com/edu_vienna_group"></a> <a class="subs-social__fb" href="http://www.facebook.com/eduvienna"></a> <a class="subs-social__tw" href="http://twitter.com/edu_vienna"></a> <a class="subs-social__gp" href="https://plus.google.com/u/0/114251018215715546789"></a> <a class="subs-social__in" href="http://www.instagram.com/edu_vienna"></a> <a class="subs-social__yt" href="http://www.youtube.com/user/eduviennacom"></a>!--></div>
    ...
    '[[~49]]' => 'feminizirovannyie-semena.html',
    '[[$count]]' => '
[[!FormIt?
   &formName=`count`
   &hooks=`spam,email,hook_FormIt_megaplanCreateClient,redirect`
