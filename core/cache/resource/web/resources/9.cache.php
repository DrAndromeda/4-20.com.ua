...
<li>Употреблять марихуану можно и в пищу.</li>
    ...
    array (
      0 => 'keywords',
      1 => 'польза марихуаны, польза конопли, конопля польза, польза от марихуаны, марихуаны польза, польза от конопли',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<head>
<title>Неповторимая польза марихуаны это реальность которую важно развивать</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0"/>
<meta name="keywords" content="польза марихуаны, польза конопли, конопля польза, польза от марихуаны, марихуаны польза, польза от конопли" />
<meta name="description" content="Если ли польза марихуаны и какие у нее полезные свойства для организма человека." />
...
<div class="university-intro" style="background: #e6e7e7 url(/assets/images/sok2/10.png) top no-repeat">   <div class="wrapper">     <div class="university-intro-i">     <!--  <h1>пупыпыукпк</h1>       <ul class="university-info"> <li>Самый крупный в Австрии</li> <li>180 учебных программ, из которых 116 на получение степени магистра</li> <li> Требует прохождение фазы STEOP, кроме специальностей, на которые предусмотрены вступительные экзамены</li> <li> <a href="#spetsialnosti-universtytetu">Специальности университета</a></li> </ul>            <a class="button button_intro" href="chto-takoe-anasha.html"> <span>Подать заявку на обучение</span> </a>!--> </div>   </div> </div>

<div class="wrapper"><div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="kurenie-marixuanyi.html">Курение марихуаны</a></li><li>Польза марихуаны</li></ul></div>     </div>
<h1>Польза марихуаны</h1>
    <div class="col2">
      <div class="col-l">
        <div class="articles"> <p>Растение конопли имеет массу возможных применений, и польза ее употребления/применения безусловно велика. Предлагаем разобраться в вопросе какая же все таки <strong>польза марихуаны</strong> и почему во всем мире это растение не дает смирения с запретом.</p>
<h2>Польза конопли в промышленности и польза марихуаны при курении и употреблении в быту</h2>
<p>Использование конопли широко распространялось по всеми миру еще за долго до существования административных учреждений и правительства, которое ее запретило. Польза конопли и ее положительное влияние на человека является несомненным. Представленный список дополняется ежемесячно, но исследования с применением марихуаны запрещены во многих странах, что замедляет процессы получения достоверной  или наверняка подтвержденной информации.</p>
<p style="font-size: 16px; font-weight: bolder;" align="left">Польза от марихуаны для тела и лечения заболеваний:</p>
<ul>
...
<form class="univer-action__form" action="polza-marixuanyi.html#univer" method="post">
...
<div class="modal-windows">
    <div class="modal-forms js-question-form">
        ...
        <div class="modal-forms-i">
            <form class="apply-form apply-form_modal js-apply-form validate" method="post" action="polza-marixuanyi.html">
...
<div class="modal-forms js-telefon-form">
        ...
        <div class="modal-forms-i">
 <form class="apply-form apply-form_modal js-apply-form validate" method="post" id="phone_form"  action="polza-marixuanyi.html">
...
',
  ...
  array (
    '[[*longtitle]]' => 'Неповторимая польза марихуаны это реальность которую важно развивать',
    '[[*keywords]]' => 'польза марихуаны, польза конопли, конопля польза, польза от марихуаны, марихуаны польза, польза от конопли',
    '[[*description]]' => 'Если ли польза марихуаны и какие у нее полезные свойства для организма человека.',
    '[[$head]]' => '<head>
<title>Неповторимая польза марихуаны это реальность которую важно развивать</title>
<meta charset="utf-8">
...
',
    ...
    '[[Breadcrumb]]' => '<ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="kurenie-marixuanyi.html">Курение марихуаны</a></li><li>Польза марихуаны</li></ul>',
    '[[$bread]]' => '<div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="kurenie-marixuanyi.html">Курение марихуаны</a></li><li>Польза марихуаны</li></ul></div>     </div>',
    '[[*pagetitle]]' => 'Польза марихуаны',
    '[[*id]]' => 9,
    '[[Wayfinder?
			&startId=`9`
