<?php  return array (
  ...
  array (
    ...
    array (
      0 => 'keywords',
      1 => 'автоцветущие феминизированные, автоцветущие феминизированные семена, автоцветущие феминизированные семена купить, автоцветущие феминизированные семена марихуаны, автоцветущие феминизированные семена это, феминизированные автоцветущие семена, авто феминизированные семена, семена автоцветущие феминизированные, автоцветущие феминизированные сорта',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<head>
<title>На 420 можно купить автоцветущие феминизированные семена конопли</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0"/>
<meta name="keywords" content="автоцветущие феминизированные, автоцветущие феминизированные семена, автоцветущие феминизированные семена купить, автоцветущие феминизированные семена марихуаны, автоцветущие феминизированные семена это, феминизированные автоцветущие семена, авто феминизированные семена, семена автоцветущие феминизированные, автоцветущие феминизированные сорта" />
<meta name="description" content="Купить автоцветущие феминизированные семена марихуаны в Украине можно от любого мирового сидбанка." />
...
<div class="wrapper"><div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="semena-marixuanyi.html">Семена марихуаны</a></li><li>Автоцветущие феминизированные семена марихуаны купить можно тут</li></ul></div>     </div>
<h1>Автоцветущие феминизированные семена марихуаны купить можно тут</h1>
    <div class="col2">
      <div class="col-l">
...
<form class="univer-action__form" action="avtoczvetushhie-feminizirovannyie-semena.html#univer" method="post">
...
<div class="modal-windows">
    <div class="modal-forms js-question-form">
        ...
        <div class="modal-forms-i">
            <form class="apply-form apply-form_modal js-apply-form validate" method="post" action="avtoczvetushhie-feminizirovannyie-semena.html">
...
<div class="modal-forms js-telefon-form">
        ...
        <div class="modal-forms-i">
 <form class="apply-form apply-form_modal js-apply-form validate" method="post" id="phone_form"  action="avtoczvetushhie-feminizirovannyie-semena.html">
...
',
  ...
  array (
    '[[*longtitle]]' => 'На 420 можно купить автоцветущие феминизированные семена конопли',
    '[[*keywords]]' => 'автоцветущие феминизированные, автоцветущие феминизированные семена, автоцветущие феминизированные семена купить, автоцветущие феминизированные семена марихуаны, автоцветущие феминизированные семена это, феминизированные автоцветущие семена, авто феминизированные семена, семена автоцветущие феминизированные, автоцветущие феминизированные сорта',
    '[[*description]]' => 'Купить автоцветущие феминизированные семена марихуаны в Украине можно от любого мирового сидбанка.',
    '[[$head]]' => '<head>
<title>На 420 можно купить автоцветущие феминизированные семена конопли</title>
<meta charset="utf-8">
...
',
    '[[*intro]]' => '',
    '[[Breadcrumb]]' => '<ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="semena-marixuanyi.html">Семена марихуаны</a></li><li>Автоцветущие феминизированные семена марихуаны купить можно тут</li></ul>',
