...
<section class="content" role="main">
    <div class="wrapper">
        <section class="text-main">
		  <h1>Как правильно прорастить семена марихуаны</h1>
		  <p> </p>
        </section>
<!--<section class="tabs">
 <div class="title">
...
<section class="send-mail-b send-mail-b_index" id="email" >
        ...
        <form name="email" class="send-mail-b__form cntmm" method="post" action="kak-pravilno-prorastit-semena-marixuanyi.html#email">
...
<form class="apply-form js-apply-form" action="kak-pravilno-prorastit-semena-marixuanyi.html#form" method="post" id="form">
...
<div class="modal-windows">
    <div class="modal-forms js-question-form">
        ...
        <div class="modal-forms-i">
            <form class="apply-form apply-form_modal js-apply-form validate" method="post" action="kak-pravilno-prorastit-semena-marixuanyi.html">
...
<div class="modal-forms js-telefon-form">
        ...
        <div class="modal-forms-i">
 <form class="apply-form apply-form_modal js-apply-form validate" method="post" id="phone_form"  action="kak-pravilno-prorastit-semena-marixuanyi.html">
...
<li>
    ...
    '[[*id]]' => 54,
    '[[~54]]' => 'kak-pravilno-prorastit-semena-marixuanyi.html',
    '[[$sendmail]]' => '[[!FormIt?
   &formName=`sendmail`
   &hooks=`spam,email,hook_FormIt_megaplanCreateClient,redirect`
   &emailTpl=`sendEmailTpl_email`
