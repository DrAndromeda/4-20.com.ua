...
<section class="intro intro_2"> <div class="wrapper"> <div class="intro__slogan intro__slogan_2">  </div> <div class="intro__rec intro__rec_2"><a class="button button_rec" onclick="window.location = \'/zakazat-obratij-zvonok.html\';"><span>Заказать</span></a></div> <div class="intro__skype">Получи детальную консультацию по Skype  </div> </div> </section>
<div class="wrapper"><div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="oborudovanie-dlya-vyirashhivaniya-marixuanyi.html">Оборудование для выращивания</a></li><li>Субстраты для проращивания и роста</li></ul></div>     </div>
<h1 class="inner-h1">Субстраты для проращивания и роста</h1>
...
<div class="button button_adm"><span style="font-size: 20px;">40 грн</span></div>
<a class="button button_adm" href="zakazat-obratij-zvonok.html?name=Субстраты для проращивания и роста" rel="nofollow"> <span>Заказать сейчас</span> </a></div>
</li>
<li><a href="zakazat-obratij-zvonok.html" rel="nofollow"><img class="col3__img" src="assets/img/UGro Pot 9 л.jpg" alt="" /></a>
<div class="col3__info"><a class="col3__title col3__title_univer" href="zakazat-obratij-zvonok.html">Кокосовый субстрат UGro Pot</a>
<div class="col3__desc">
...
<div class="modal-windows">
    <div class="modal-forms js-question-form">
        ...
        <div class="modal-forms-i">
            <form class="apply-form apply-form_modal js-apply-form validate" method="post" action="substratyi-dlya-prorashhivaniya-i-rosta.html">
...
<div class="modal-forms js-telefon-form">
        ...
        <div class="modal-forms-i">
 <form class="apply-form apply-form_modal js-apply-form validate" method="post" id="phone_form"  action="substratyi-dlya-prorashhivaniya-i-rosta.html">
...
',
    '[[*intro]]' => '<section class="intro intro_2"> <div class="wrapper"> <div class="intro__slogan intro__slogan_2">  </div> <div class="intro__rec intro__rec_2"><a class="button button_rec" onclick="window.location = \'/zakazat-obratij-zvonok.html\';"><span>Заказать</span></a></div> <div class="intro__skype">Получи детальную консультацию по Skype  </div> </div> </section>',
    '[[Breadcrumb]]' => '<ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="oborudovanie-dlya-vyirashhivaniya-marixuanyi.html">Оборудование для выращивания</a></li><li>Субстраты для проращивания и роста</li></ul>',
...
<!-- /Yandex.Metrika counter !-->
    ...
    '[[*id]]' => 65,
    '[[~65]]' => 'substratyi-dlya-prorashhivaniya-i-rosta.html',
    '[[$forms]]' => '[[#!FormIt?
   &formName=`forms1`
   &hooks=`email,hook_FormIt_megaplanCreateClient,redirect`
   &emailTpl=`email_tpl`
