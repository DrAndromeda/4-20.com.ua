...
<hr />',
    ...
    array (
      0 => 'keywords',
      1 => 'как выращивать марихуану, выращивание марихуаны, выращивание конопли, как вырастить марихуану, как вырастить семена конопли, вырастить коноплю',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<head>
<title>Как выращивать марихуану сортовую и коноплю </title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0"/>
<meta name="keywords" content="как выращивать марихуану, выращивание марихуаны, выращивание конопли, как вырастить марихуану, как вырастить семена конопли, вырастить коноплю" />
<meta name="description" content="Здесь Вы найдете все что нужно знать про выращивание марихуаны, о том как выращивать коноплю и как прорастить семена марихуаны." />
...
<div class="wrapper"><div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li>Как выращивать марихуану и детали про выращивание</li></ul></div>     </div>
<h1>Как выращивать марихуану и детали про выращивание</h1>
    <div class="col2">
      <div class="col-l">
        <div class="articles"> <p><img title="Как выращивать марихуану в закрытых лабораториях" src="assets/img/kak-virashivat-marihyany.png" alt="узнайте как выращивать марихуану индор" width="100%" />На страницах данного ресурса Вы узнаете все про выращивание марихуаны<span style="line-height: 1.5em;">, об удобрениях и методах безопасного увеличения объемов конопли для максимального сбора урожая. Но перед тем как узнать о том <strong>как выращивать марихуану</strong>, важно знать и помнить о том что выращивание и распространение марихуаны запрещено Законодательством Украины и преследуется законом. <br /><span style="font-size: 17px;">Подробнее о мерах наказания за выращивание конопли, ее хранение и распространение - <a style="color: #4bd12e;" href="zakon-za-vyirashhivanie-marixuanyi.html">4-20.com.ua/zakon-za-vyirashhivanie-marixuanyi.html</a></span></span></p>
<h2>Как выращивать марихуану для курения и коноплю для бытовых целей</h2>
<p>Выращивание марихуаны распределяется на два больших вида - в помещении (индор) и на улице (аутдор). Каждый из этих видов имеет свои особенности и подвиды выращивания. Так например конопля выращивания которой проходит в закрытом пространстве может выращиваться методом разделения каждого растения по горшкам и называться гидропоникой. Или так же для выращивания в закрытом помещении применяется метод "аэропоника" когда растение и вовсе не садиться в грун, а растет прямо-таки в воздухе. <span style="line-height: 1.5em;">Аутдорные методы выращивания марихуаны - это высадка пророщенных семян в открытый грунт и выращивание в теплицах. Каждый из этих методов имеет своих приверженцев, свои плюсы и минусы. Но какой бы Вы не выбрали для себя метод, основой для достижения положительного результата являются жизненно необходимые отличные условия для того чтобы вырастить коноплю с хороших урожаем.</span></p>
<p style="font-size: 22px;">Как вырастить марихуану эффективно<img style="float: right;" title="Выращивание марихуаны аутдор на улице" src="assets/img/kak-virashivat-konoply.png" alt="как проходит выращивание марихуаны на улице " width="493" height="750" /></p>
<ul>
...
<!--<ul><li class="first"><a href="vyirashhivanie-marixuanyi-v-otkryitom-grunte.html" title="Выращивание марихуаны в открытом грунте" >В открытом грунте - аутдор</a></li>
<li><a href="vyirashhivanie-konopli-v-domashnix-usloviyax.html" title="Выращивание конопли в домашних условиях" >В закрытом грунте - индор</a></li>
<li><a href="kak-pravilno-prorastit-semena-marixuanyi.html" title="Как правильно прорастить семена марихуаны" >Проращивание семян</a></li>
<li class="last"><a href="gidroponika-marixuanyi.html" title="Гидропоника марихуаны" >Гидропоника</a></li>
</ul>!-->
</ul></div>
...
<form class="univer-action__form" action="vyirashhivanie-marixuanyi.html#univer" method="post">
...
<div class="modal-windows">
    <div class="modal-forms js-question-form">
        ...
        <div class="modal-forms-i">
            <form class="apply-form apply-form_modal js-apply-form validate" method="post" action="vyirashhivanie-marixuanyi.html">
...
<div class="modal-forms js-telefon-form">
        ...
        <div class="modal-forms-i">
 <form class="apply-form apply-form_modal js-apply-form validate" method="post" id="phone_form"  action="vyirashhivanie-marixuanyi.html">
...
',
  ...
  array (
    '[[*longtitle]]' => 'Как выращивать марихуану сортовую и коноплю ',
    '[[*keywords]]' => 'как выращивать марихуану, выращивание марихуаны, выращивание конопли, как вырастить марихуану, как вырастить семена конопли, вырастить коноплю',
    '[[*description]]' => 'Здесь Вы найдете все что нужно знать про выращивание марихуаны, о том как выращивать коноплю и как прорастить семена марихуаны.',
    '[[$head]]' => '<head>
<title>Как выращивать марихуану сортовую и коноплю </title>
<meta charset="utf-8">
...
',
    '[[*intro]]' => '',
    '[[Breadcrumb]]' => '<ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li>Как выращивать марихуану и детали про выращивание</li></ul>',
    '[[$bread]]' => '<div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li>Как выращивать марихуану и детали про выращивание</li></ul></div>     </div>',
    '[[*pagetitle]]' => 'Как выращивать марихуану и детали про выращивание',
    '[[*id]]' => 3,
    '[[Wayfinder?
			&startId=`3`
			&level=`1`
			&ignoreHidden=`1`]]' => '<ul><li class="first"><a href="vyirashhivanie-marixuanyi-v-otkryitom-grunte.html" title="Выращивание марихуаны в открытом грунте" >В открытом грунте - аутдор</a></li>
<li><a href="vyirashhivanie-konopli-v-domashnix-usloviyax.html" title="Выращивание конопли в домашних условиях" >В закрытом грунте - индор</a></li>
<li><a href="kak-pravilno-prorastit-semena-marixuanyi.html" title="Как правильно прорастить семена марихуаны" >Проращивание семян</a></li>
<li class="last"><a href="gidroponika-marixuanyi.html" title="Гидропоника марихуаны" >Гидропоника</a></li>
</ul>',
...
<div class="subs-social"><a class="subs-social__vk" href="https://vk.com/edu_vienna_group"></a> <a class="subs-social__fb" href="http://www.facebook.com/eduvienna"></a> <a class="subs-social__tw" href="http://twitter.com/edu_vienna"></a> <a class="subs-social__gp" href="https://plus.google.com/u/0/114251018215715546789"></a> <a class="subs-social__in" href="http://www.instagram.com/edu_vienna"></a> <a class="subs-social__yt" href="http://www.youtube.com/user/eduviennacom"></a>!--></div>
    ...
    '[[~3]]' => 'vyirashhivanie-marixuanyi.html',
    '[[$count]]' => '
[[!FormIt?
   &formName=`count`
   &hooks=`spam,email,hook_FormIt_megaplanCreateClient,redirect`
