...
<head>
<title>Выращивание сортовой марихуаны и конопли в домашних условиях</title>
<meta charset="utf-8">
...
<section class="content" role="main">
    <div class="wrapper">
        <section class="text-main">
		  <h1>Выращивание конопли в домашних условиях</h1>
		  <p> </p>
        </section>
<!--<section class="tabs">
 <div class="title">
...
<section class="send-mail-b send-mail-b_index" id="email" >
        ...
        <form name="email" class="send-mail-b__form cntmm" method="post" action="vyirashhivanie-konopli-v-domashnix-usloviyax.html#email">
...
<form class="apply-form js-apply-form" action="vyirashhivanie-konopli-v-domashnix-usloviyax.html#form" method="post" id="form">
...
<div class="modal-windows">
    <div class="modal-forms js-question-form">
        ...
        <div class="modal-forms-i">
            <form class="apply-form apply-form_modal js-apply-form validate" method="post" action="vyirashhivanie-konopli-v-domashnix-usloviyax.html">
...
<div class="modal-forms js-telefon-form">
        ...
        <div class="modal-forms-i">
 <form class="apply-form apply-form_modal js-apply-form validate" method="post" id="phone_form"  action="vyirashhivanie-konopli-v-domashnix-usloviyax.html">
...
<li>
    ...
    '[[*id]]' => 53,
    '[[~53]]' => 'vyirashhivanie-konopli-v-domashnix-usloviyax.html',
    '[[$sendmail]]' => '[[!FormIt?
   &formName=`sendmail`
   &hooks=`spam,email,hook_FormIt_megaplanCreateClient,redirect`
   &emailTpl=`sendEmailTpl_email`
