...
<p style="font-size: 16px; font-weight: bolder;">Администрация 4-20.com.ua снимает с себя любую ответственность за беззаконное использование конопли, для  незаконных целей и противоречащих закону!</p>',
    ...
    array (
      0 => 'keywords',
      1 => 'выращивание марихуаны закон, выращивание марихуаны закон Украины',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<head>
<title>За выращивание марихуаны закон наказывает</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0"/>
<meta name="keywords" content="выращивание марихуаны закон, выращивание марихуаны закон Украины" />
<meta name="description" content="Поскольку выращивание марихуаны закон запрещает, прийдется заплатить большой штраф или загреметь в тюрьму." />
...
<div class="wrapper"><div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="kurenie-marixuanyi.html">Курение марихуаны</a></li><li>Наказание за выращивание марихуаны закон Украины</li></ul></div>     </div>
<h1>Наказание за выращивание марихуаны закон Украины</h1>
    <div class="col2">
      <div class="col-l">
        <div class="articles"> <p>Не знание закона не освобождает от ответственности! Ознакомьтесь со всеми видами нарушений предусмотренных Уголовным Кодексом Украины и Законом Украины, а так же разными статьями. Существует два вида ответственности за выращивание, хранение и употребление наркотических препаратов, в данном случае марихуаны - <span>административная и уголовная. <strong>Выращивание марихуаны закон</strong> Украины 310, статьи 106-2, статья 309, 315. </span></p>
<h2>Статьи Уголовеного Кодекса про выращивание марихуаны Закон Украины</h2>
<p><img style="float: left;" title="За выращивание марихуаны закон предусматривает наказание" src="assets/images/zakon-o-virashivanii-marihyani.png" alt="выращивание марихуаны закон и наказание " width="420" height="214" />Выращивание конопли в Украине и других странах СНГ запрещено и преследуеться законом. Ниже представлены адменистративные и уголовные наказание за совершение незаконных правонарушений. <span style="font-weight: bolder; color: #f82306;">Кодекс Украины, в статье 106-2,</span> предписывает административные правонарушения <span style="font-weight: bolder; color: #4fa819;">за посев и выращивание конопли в размере до 10 (десяти) растений</span>. Такое правонарушение предусматривает <span style="font-weight: bolder; color: #4fa819;">штраф от 300 до 1700 гривен, и предусматривает конфискацию незаконно выращенных растений</span>. Растением считается один корень, вне зависимости от количества ростков. При нахождении растений конопли до 10ти кустов, сотрудник правоохранительных органов составляет админ протокол, в результате которого решением суда уточняется размер штрафа.</p>
<p>В случае когда выращивание растений конопли превышает 10 кустов, наступает уголовная ответственность. <span style="font-weight: bolder; color: #f82306;">Созласно 310 статье Уголовного кодекса Украины</span>, марихуаны <span style="font-weight: bolder; color: #4fa819;">варащивание в количестве от 10ти до 50ти растений, влечет за собой наложение штрафа от 1700 гривен до 9000 гривен, а так же/или арест гровера на срок до 6 месяцев с последующим/или ограничением сободы до 3х лет.</span></p>
<p>Так же, если выращиватель конопли добровольно выдал нарконические средства (марихуану, гашиш и тд), и помогал следствию в раскрытии дел с незаконным оборотом наркотиков, такое лицо освобождается от уголовной ответственности (но не административной) за производство, покупку, хранение или перевозку-пересылку.</p>
...
<p><span style="color: #4fa819; font-weight: bolder; line-height: 1.5em;">Все превышающие нормы квалифицинуются как уголовные нарушения и наказываються или штрафом от 850 до 1700 гривен и сроком лишения свободы от 3-6 лет.</span></p>
<hr />
<p style="font-size: 16px; font-weight: bolder;">Администрация 4-20.com.ua снимает с себя любую ответственность за беззаконное использование конопли, для  незаконных целей и противоречащих закону!</p></div></div>
<div class="col-r">
<div class="col-r">
...
<form class="univer-action__form" action="zakon-za-vyirashhivanie-marixuanyi.html#univer" method="post">
...
<div class="modal-windows">
    <div class="modal-forms js-question-form">
        ...
        <div class="modal-forms-i">
            <form class="apply-form apply-form_modal js-apply-form validate" method="post" action="zakon-za-vyirashhivanie-marixuanyi.html">
...
<div class="modal-forms js-telefon-form">
        ...
        <div class="modal-forms-i">
 <form class="apply-form apply-form_modal js-apply-form validate" method="post" id="phone_form"  action="zakon-za-vyirashhivanie-marixuanyi.html">
...
',
  ...
  array (
    '[[*longtitle]]' => 'За выращивание марихуаны закон наказывает',
    '[[*keywords]]' => 'выращивание марихуаны закон, выращивание марихуаны закон Украины',
    '[[*description]]' => 'Поскольку выращивание марихуаны закон запрещает, прийдется заплатить большой штраф или загреметь в тюрьму.',
    '[[$head]]' => '<head>
<title>За выращивание марихуаны закон наказывает</title>
<meta charset="utf-8">
...
',
    ...
    '[[Breadcrumb]]' => '<ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="kurenie-marixuanyi.html">Курение марихуаны</a></li><li>Наказание за выращивание марихуаны закон Украины</li></ul>',
    '[[$bread]]' => '<div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="kurenie-marixuanyi.html">Курение марихуаны</a></li><li>Наказание за выращивание марихуаны закон Украины</li></ul></div>     </div>',
    '[[*pagetitle]]' => 'Наказание за выращивание марихуаны закон Украины',
    '[[*id]]' => 55,
    '[[Wayfinder?
			&startId=`55`
...
<div class="subs-social"><a class="subs-social__vk" href="https://vk.com/edu_vienna_group"></a> <a class="subs-social__fb" href="http://www.facebook.com/eduvienna"></a> <a class="subs-social__tw" href="http://twitter.com/edu_vienna"></a> <a class="subs-social__gp" href="https://plus.google.com/u/0/114251018215715546789"></a> <a class="subs-social__in" href="http://www.instagram.com/edu_vienna"></a> <a class="subs-social__yt" href="http://www.youtube.com/user/eduviennacom"></a>!--></div>
    ...
    '[[~55]]' => 'zakon-za-vyirashhivanie-marixuanyi.html',
    '[[$count]]' => '
[[!FormIt?
   &formName=`count`
   &hooks=`spam,email,hook_FormIt_megaplanCreateClient,redirect`
