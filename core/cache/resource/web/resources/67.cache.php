<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Натриевая лампа GIB Lighting Pure Bloom',
    'longtitle' => '',
    'description' => '',
    'alias' => 'natrievaya-lampa-gib-lighting-pure-bloom',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
...
<div class="intro__rec_2"><a class="button button_rec" onclick="window.location = \'/zakazat-obratij-zvonok.html?name=[[*pagetitle]]\';"><span>Заказать</span></a></div>',
    'richtext' => 1,
    'template' => 7,
    'menuindex' => 5,
    'searchable' => 1,
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1452596836,
    'editedby' => 1,
    'editedon' => 1452639946,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1452596940,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'natrievaya-lampa-gib-lighting-pure-bloom.html',
    'uri_override' => 0,
...
<div class="wrapper"><div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="oborudovanie-dlya-vyirashhivaniya-marixuanyi.html">Оборудование для выращивания</a></li><li><a href="lampyi-dlya-vyirashhivaniya-marixuanyi.html">Лампы для выращивания марихуаны</a></li><li><a href="lampyi-i-cooltube.html">Лампы и cooltube</a></li><li>Натриевая лампа GIB Lighting Pure Bloom</li></ul></div>     </div>
<h1>Натриевая лампа GIB Lighting Pure Bloom</h1>
    <div class="col2">
      <div class="col-l">
        <div class="articles"> <p><img style="float: left;" src="assets/img/GIB%20Lighting%20Pure%20Bloom%20Spectrum.png" alt="" width="440" height="440" /></p>
<p style="font-size: 18px; font-weight: bolder;">Модель: GIB Lighting Pure Bloom Spectrum XTreme Output</p>
<p style="font-size: 18px; font-weight: bolder;">Мощность: 600 W</p>
<p>Имеет наибольшее количество выработки люменов среди всех похожи моделей. Лучшая лампа для активного цветения светолюбивых растений. Обеспечивает высокую светоотдачу и оптимальный уровень микромолей. Подходит для использования в период цветения растений. Обеспечивает стабильный световой поток, тем самым увеличивая уровень урожайности. Производство: Германия.</p>
<p style="font-size: 18px;">Технические характеристики :</p>
...
<div class="intro__rec_2"><a class="button button_rec" onclick="window.location = \'/zakazat-obratij-zvonok.html?name=Натриевая лампа GIB Lighting Pure Bloom\';"><span>Заказать</span></a></div></div></div>
<div class="col-r">
<div class="col-r">
...
<form class="univer-action__form" action="natrievaya-lampa-gib-lighting-pure-bloom.html#univer" method="post">
...
<div class="modal-windows">
    <div class="modal-forms js-question-form">
        ...
        <div class="modal-forms-i">
            <form class="apply-form apply-form_modal js-apply-form validate" method="post" action="natrievaya-lampa-gib-lighting-pure-bloom.html">
...
<div class="modal-forms js-telefon-form">
        ...
        <div class="modal-forms-i">
 <form class="apply-form apply-form_modal js-apply-form validate" method="post" id="phone_form"  action="natrievaya-lampa-gib-lighting-pure-bloom.html">
...
',
    '[[*intro]]' => '',
    '[[Breadcrumb]]' => '<ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="oborudovanie-dlya-vyirashhivaniya-marixuanyi.html">Оборудование для выращивания</a></li><li><a href="lampyi-dlya-vyirashhivaniya-marixuanyi.html">Лампы для выращивания марихуаны</a></li><li><a href="lampyi-i-cooltube.html">Лампы и cooltube</a></li><li>Натриевая лампа GIB Lighting Pure Bloom</li></ul>',
...
<div class="subs-social"><a class="subs-social__vk" href="https://vk.com/edu_vienna_group"></a> <a class="subs-social__fb" href="http://www.facebook.com/eduvienna"></a> <a class="subs-social__tw" href="http://twitter.com/edu_vienna"></a> <a class="subs-social__gp" href="https://plus.google.com/u/0/114251018215715546789"></a> <a class="subs-social__in" href="http://www.instagram.com/edu_vienna"></a> <a class="subs-social__yt" href="http://www.youtube.com/user/eduviennacom"></a>!--></div>
    ...
    '[[~67]]' => 'natrievaya-lampa-gib-lighting-pure-bloom.html',
    '[[$count]]' => '
[[!FormIt?
   &formName=`count`
   &hooks=`spam,email,hook_FormIt_megaplanCreateClient,redirect`
