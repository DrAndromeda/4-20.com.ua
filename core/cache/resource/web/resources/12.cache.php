...
<div class="wrapper"><div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li>Подать заявку или заказать обратный звонок</li></ul></div>     </div>
<h1>Подать заявку или заказать обратный звонок</h1>
    <div class="col2">
      <div class="col-l">
        <div class="articles"> <div class="col2 apply-section toHide600">
<div class="col-l">
<div class="articles">
<div class="order-form-bl clear">
<div class="right_txt">
...
[[!FormIt?
   ...
   &emailSubject=`Заявка на заказ http://4-20.com.ua/`
   &redirectTo=`360`
   &validate=`phone:required`
   &submitVar=`form-question`
]]
[[!+fi.error_message:notempty=`<p>[[!+fi.error_message]]</p>`]]
<!--form action="zakazat-obratij-zvonok.html" method="post" class="form">
...
<form class="apply-form apply-form_order js-apply-form"   action="zakazat-obratij-zvonok.html#form" method="post" id="form">
...
<input class="submit_button button button_apply js-telefon" type="submit" name="form-question" value="Отправить" /></form></div></div>
</div>
</div>
<div class="col-r"> </div>
</div>
...
<p style="text-align: center; font-size: 18px;"><em style="font-weight: bolder;">Если Вы не уверенны или сомневаетесь при выборе какого либо товара, Вы можете связаться по телефону или emeil  с нашими экспертами. Мы обязательно поможем Вам разобраться во всех сомнительных вопросах!</em></p></div></div>
<div class="col-r">
<div class="col-r">
...
<form class="univer-action__form" action="zakazat-obratij-zvonok.html#univer" method="post">
...
<div class="modal-windows">
    <div class="modal-forms js-question-form">
        ...
        <div class="modal-forms-i">
            <form class="apply-form apply-form_modal js-apply-form validate" method="post" action="zakazat-obratij-zvonok.html">
...
<div class="modal-forms js-telefon-form">
        ...
        <div class="modal-forms-i">
 <form class="apply-form apply-form_modal js-apply-form validate" method="post" id="phone_form"  action="zakazat-obratij-zvonok.html">
...
',
    '[[*intro]]' => '',
    '[[Breadcrumb]]' => '<ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li>Подать заявку или заказать обратный звонок</li></ul>',
    '[[$bread]]' => '<div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li>Подать заявку или заказать обратный звонок</li></ul></div>     </div>',
    '[[*pagetitle]]' => 'Подать заявку или заказать обратный звонок',
    '[[*id]]' => 12,
    '[[~12]]' => 'zakazat-obratij-zvonok.html',
    '[[$form1]]' => '[[!FormIt?
   &formName=`form1`
   &hooks=`spam,email,hook_FormIt_megaplanCreateClient,redirect`
   &emailTpl=`sendEmailTpl`
