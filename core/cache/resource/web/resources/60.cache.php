...
<a class="button button_adm" href="sistema-autopot-i-aquapot.html" rel="nofollow"> <span>Перейти в раздел</span> </a></div>
    ...
    array (
      0 => 'keywords',
      1 => 'системы полива, система автоматического полива, системы автоматического полива, системы полива купить, автоматический полив, система полива, автоматические системы полива, система автополива',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<head>
<title>Системы полива для гидропонных и других установок</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0"/>
<meta name="keywords" content="системы полива, система автоматического полива, системы автоматического полива, системы полива купить, автоматический полив, система полива, автоматические системы полива, система автополива" />
<meta name="description" content="Автоматические и полуавтоматические системы полива для марихуаны и других растений, а так же дополнительное оборудование к системам." />
...
<section class="intro intro_2"> <div class="wrapper"> <div class="intro__slogan intro__slogan_2">Системы полива для гидропонных и других установок  </div> <div class="intro__rec intro__rec_2"><a class="button button_rec" onclick="window.location = \'/zakazat-obratij-zvonok.html\';"><span>Заказать</span></a></div> <div class="intro__skype">Получи детальную консультацию по Skype  </div> </div> </section>
<div class="wrapper"><div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="oborudovanie-dlya-vyirashhivaniya-marixuanyi.html">Оборудование для выращивания</a></li><li>Системы полива</li></ul></div>     </div>
<h1 class="inner-h1">Системы полива</h1>
<div class="articles"><p> </p></div></div>
<div class="wrapper"><div class="articles"><p><span style="line-height: 1.5em;"> </span></p>
<h2>На сайте Вы можете купить системы полива растений</h2>
<ul class="col3">
<li><a href="aeroponika.html"><img class="col3__img" src="assets/img/aeroponic.jpg" alt="" /></a>
<div class="col3__info"><a class="col3__title col3__title_univer" href="aeroponika.html">Аэропоника</a>
...
<div class="modal-windows">
    <div class="modal-forms js-question-form">
        ...
        <div class="modal-forms-i">
            <form class="apply-form apply-form_modal js-apply-form validate" method="post" action="sistemyi-poliva.html">
...
<div class="modal-forms js-telefon-form">
        ...
        <div class="modal-forms-i">
 <form class="apply-form apply-form_modal js-apply-form validate" method="post" id="phone_form"  action="sistemyi-poliva.html">
...
<script>
  ...
  array (
    '[[*longtitle]]' => 'Системы полива для гидропонных и других установок',
    '[[*keywords]]' => 'системы полива, система автоматического полива, системы автоматического полива, системы полива купить, автоматический полив, система полива, автоматические системы полива, система автополива',
    '[[*description]]' => 'Автоматические и полуавтоматические системы полива для марихуаны и других растений, а так же дополнительное оборудование к системам.',
    '[[$head]]' => '<head>
<title>Системы полива для гидропонных и других установок</title>
<meta charset="utf-8">
...
',
    '[[*intro]]' => '<section class="intro intro_2"> <div class="wrapper"> <div class="intro__slogan intro__slogan_2">Системы полива для гидропонных и других установок  </div> <div class="intro__rec intro__rec_2"><a class="button button_rec" onclick="window.location = \'/zakazat-obratij-zvonok.html\';"><span>Заказать</span></a></div> <div class="intro__skype">Получи детальную консультацию по Skype  </div> </div> </section>',
    '[[Breadcrumb]]' => '<ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="oborudovanie-dlya-vyirashhivaniya-marixuanyi.html">Оборудование для выращивания</a></li><li>Системы полива</li></ul>',
    '[[$bread]]' => '<div  class="breadcrumbs">       <div itemscope itemtype="http://data-vocabulary.org/Breadcrumb"><ul id="breadcrumb" itemprop="breadcrumb"><li><a href="http://4-20.com.ua/">Все о марихуане</a></li><li><a href="oborudovanie-dlya-vyirashhivaniya-marixuanyi.html">Оборудование для выращивания</a></li><li>Системы полива</li></ul></div>     </div>',
    '[[*pagetitle]]' => 'Системы полива',
    '[[*introtext]]' => '',
    '[[$xxx]]' => '<div class="justy">
<p style="font-size: 24px; color: #fd2901; text-align: center;">!!! ВНИМАНИЕ !!!</p>
