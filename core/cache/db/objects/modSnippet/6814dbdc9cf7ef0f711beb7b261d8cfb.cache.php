<?php  return array (
  ...
  array (
    ...
    'modSnippet_name' => 'getResources',
    'modSnippet_description' => '<strong>1.6.1-pl</strong> A general purpose Resource listing and summarization snippet for MODX Revolution',
